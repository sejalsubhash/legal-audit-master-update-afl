...
// All /api/masters/* endpoints are admin-only.
// authenticate validates the Bearer token; requireAdmin then re-checks
// the user's email against the current ADMIN_EMAILS env var on every
// request, so revoking admin access takes effect immediately.
