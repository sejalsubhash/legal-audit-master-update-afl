...
// ─────────────────────────────────────────────────────────────────────────────
// NOTE: Presigned URL helpers (getSignedDownloadUrl, getSignedUploadUrl) have
// been intentionally removed. All file access — uploads and report downloads —
// now flows through the Express backend proxy endpoints so S3 is never exposed
// directly to the browser. The @aws-sdk/s3-request-presigner package is no
// longer needed; you can remove it from package.json if you wish.
// ─────────────────────────────────────────────────────────────────────────────
